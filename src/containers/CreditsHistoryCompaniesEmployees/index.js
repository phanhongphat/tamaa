...
import CreditsHistoryCompaniesEmployees from 'src/containers/CreditsHistoryCompaniesEmployees/Table';
			...
			<>
				...
				<Card style={{ minHeight: 360, marginTop: '16px' }} bordered={false}>
					...
					<Spin spinning={loading}>
						<CreditsHistoryCompaniesEmployees role={'Tama'} data={dataTransactions} />
