...
import NewResetPassword from 'src/components/Form/NewResetPassword';
...
export default class ResetPasswordNewAccountLayout extends PureComponent {
	state = {
		token: '',
		roles: ''
	};
							...
							<div className={classes.wrapLeft}>
								...
								<div className={classes.leftBody}>
									<div className={classes.form}>
										...
										<NewResetPassword token={token} roles={roles} />
									</div>
								</div>
							</div>
						</Col>
