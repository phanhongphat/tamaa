...
import CreditsHistoryCompaniesTable from 'src/containers/CreditsHistoryCompanies/Table';
			...
			<>
				...
				<Card style={{ minHeight: 360, marginTop: '16px' }} bordered={false}>
					...
					<Spin spinning={loading}>
						<CreditsHistoryCompaniesTable role={'Tama'} data={dataTransactions} />
